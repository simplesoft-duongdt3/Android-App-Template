...
import tinyapps.apptemplate.base.util.converters.UnitConverter;
import tinyapps.apptemplate.base.util.etc.ThreadUtil;
...
public class KeyboardUtil {
    ...
    public static int getHeight() {
        if (height <= 0)
            height = ContextUtil.getSharedPreferences(KEYBOARD_UTIL_PREF, Context.MODE_PRIVATE).getInt(KEYBOARD_HEIGHT, UnitConverter.dpToPx(DEFAULT_KEYBOARD_HEIGHT));
    ...
    public static void setHeight(int height) {
        ...
        ContextUtil.getSharedPreferences(KEYBOARD_UTIL_PREF, Context.MODE_PRIVATE).edit().putInt(KEYBOARD_HEIGHT, height).apply();
    }
