...
import tinyapps.apptemplate.base.util.enums.Rotation;
...
public class DisplayUtil {
    ...
    public static int getWidth() {
        Display display = ServiceUtil.getWindowManager().getDefaultDisplay();
    ...
    public static Rotation getRotation() {
        if (APILevel.require(8))
            return Rotation.fromValue(ServiceUtil.getWindowManager().getDefaultDisplay().getRotation());
        else
            return Rotation.fromValue(ServiceUtil.getWindowManager().getDefaultDisplay().getOrientation());
    }
