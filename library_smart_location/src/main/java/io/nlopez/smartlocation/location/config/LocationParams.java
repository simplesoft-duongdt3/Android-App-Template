...
public class LocationParams {
    ...
    public static final LocationParams BEST_EFFORT = new Builder().setAccuracy(LocationAccuracy.MEDIUM).setDistance(50).setInterval(2500).build();
    ...
    LocationParams(LocationAccuracy accuracy, long interval, long fastInterval, float distance) {
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(that.distance, distance) == 0 && interval == that.interval && fastInterval == that.fastInterval && accuracy == that.accuracy;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) (fastInterval ^ (fastInterval >>> 32));
    ...
    public static class Builder {
        ...
        public LocationParams build() {
            return new LocationParams(accuracy, interval, fastInterval, distance);
        }
    }
}
